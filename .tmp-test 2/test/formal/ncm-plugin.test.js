...
import { createExtensionRuntime, platformLibraryProviderSlot, sourceProviderSlot, } from "../../src/extension/index.js";
import { createNcmPlugin, ncmPluginId, ncmProviderId, } from "../../src/extension/plugins/index.js";
...
const nonObjectConfigProvider = await sourceProviderFor(null);
...
async function sourceProviderFor(config) {
...
async function platformLibraryProviderFor(config) {
    const plugin = createNcmPlugin(config);
    let provider;
    const context = {
        pluginId: ncmPluginId,
