...
const testModules = [
    ...
    "./formal/music-experience-queue-occ.test.js",
    ...
    "./formal/library-import-job.test.js",
    ...
    "./formal/agent-runtime-session-unification.test.js",
    "./formal/agent-runtime-transcript-store.test.js",
    ...
    "./formal/agent-runtime-radio-refill-runner.test.js",
    "./formal/radio-endurance.test.js",
    "./formal/active-tree.test.js",
    "./formal/mcp-stdio-transport.test.js",
    "./formal/audio-backend-primitives-composition.test.js",
    ...
    "./formal/postgres-schema-contributions.test.js",
    ...
    "./formal/playback-source-resolver.test.js",
    ...
    "./formal/download-command.test.js",
    ...
    "./formal/server-local-audio-serving.test.js",
