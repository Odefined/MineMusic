...
export type _stageToolContextShape = Expect<Equal<keyof StageToolContext, "ownerScope" | "sessionId" | "requestId" | "actor" | "actorTrustBasis" | "askBeforeSourceOfTruthEdits" | "preconditionBasis" | "clock" | "abortSignal" | "handleMinting" | "lookupCursors" | "providerAvailability" | "executionGate" | "audit">>;
