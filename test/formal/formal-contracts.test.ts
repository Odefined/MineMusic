...
import type { FrozenOwningCommand, ProposalToolDescriptorSnapshot, ProposalUnit, ProposalUnitDecision, ProposalUnitState, ProposalUnitStore } from "../../src/contracts/effect_boundary.js";
...
export type _stageToolDeclarationShape = Expect<Equal<keyof ToolDeclaration, "name" | "instrumentId" | "label" | "ownerArea" | "description" | "usage" | "examples" | "sideEffect" | "invocationPolicy" | "inputSchema" | "outputSchema" | "errors" | "resultSummary" | "agentResultText" | "allowedActions" | "requiresProvider"> & Equal<ForbiddenKeys<ToolDeclaration, "outputPolicy" | "runtimePolicy" | "contractVersion">, never>>;
export type _toolSideEffectShape = Expect<Equal<keyof ToolSideEffect, "durableUserStateWrite" | "ownerCurationWrite" | "runtimeStateWrite" | "externalCall">>;
export type _toolInvocationPolicyShape = Expect<Equal<keyof ToolInvocationPolicy, "defaultDecision" | "impactClass" | "dataEgress" | "readOnlyHint" | "destructiveHint" | "maxCallsPerTurn"> & Equal<ForbiddenKeys<ToolInvocationPolicy, "admissionDrivenByPresentation" | "intakeDrivenByUserRequest" | "ownerRelationDrivenByUserRequest" | "collectionDrivenByUserRequest">, never>>;
export type _libraryRelationPublicShapes = Expect<Equal<keyof LibraryRelationItemInput, "item"> & Equal<LibraryRelationItemInput["item"], MaterialMusicItemHandle> & Equal<keyof LibraryRelationStateOutput, "relations"> & Equal<keyof LibraryRelationStateOutput["relations"], "saved" | "favorite" | "blocked">>;
export type _stageToolContextShape = Expect<Equal<keyof StageToolContext, "ownerScope" | "sessionId" | "requestId" | "actor" | "actorTrustBasis" | "askBeforeSourceOfTruthEdits" | "preconditionBasis" | "clock" | "abortSignal" | "handleMinting" | "lookupCursors" | "providerAvailability" | "executionGate" | "proposalUnits" | "audit">>;
export type _stageToolExecutionGatePreflightInputShape = Expect<Equal<keyof StageToolExecutionGatePreflightInput, "descriptor" | "ownerScope" | "sessionId" | "requestId" | "arguments" | "actorTrustBasis" | "askBeforeSourceOfTruthEdits">>;
export type _stageToolExecutionGatePreflightResultShape = Expect<Equal<keyof StageToolExecutionGatePreflightResult, "decision" | "auditLevel" | "publicReason" | "internalReason"> & Equal<StageToolExecutionGatePreflightResult["decision"], "allow" | "ask" | "raise-to-conversation" | "deny"> & Equal<ForbiddenKeys<StageToolExecutionGatePreflightResult, "reason">, never>>;
export type _proposalUnitStateShape = Expect<Equal<ProposalUnitState, "pending" | "confirmed" | "rejected" | "expired" | "voided_stale"> & Equal<ProposalUnitDecision, "confirm" | "reject">>;
export type _proposalToolDescriptorSnapshotShape = Expect<
    Equal<keyof ProposalToolDescriptorSnapshot, "name" | "instrumentId" | "label" | "ownerArea" | "description" | "usage" | "examples" | "sideEffect" | "invocationPolicy" | "inputSchema" | "outputSchema" | "errors" | "allowedActions" | "requiresProvider"> &
    Equal<ForbiddenKeys<ProposalToolDescriptorSnapshot, "resultSummary" | "agentResultText">, never>
>;
export type _frozenOwningCommandShape = Expect<Equal<keyof FrozenOwningCommand, "descriptor" | "arguments">>;
export type _proposalUnitShape = Expect<
    Equal<keyof ProposalUnit, "proposalUnitId" | "ownerScope" | "frozenOwningCommand" | "basis" | "state" | "provenance" | "createdAt" | "expiresAt" | "resolvedAt"> &
    Equal<ForbiddenKeys<ProposalUnit, "effectKind" | "structuredFacts" | "stale" | "outcome">, never>
>;
export type _proposalUnitStoreShape = Expect<Equal<keyof ProposalUnitStore, "park" | "resolve" | "expire" | "recheckBasis">>;
...
export type _musicExperienceTruthShapes = Expect<Equal<MusicExperiencePlaybackStatus, "playing" | "paused"> & Equal<RadioWakeGateState, "Running" | "Paused" | "Shutdown"> & Equal<MusicExperienceQueueItemProvenance, "main_agent" | "user" | "radio_agent"> & Equal<keyof MusicExperienceQueueItemSnapshot, "position" | "materialRef" | "provenance"> & Equal<keyof MusicExperiencePlaybackSnapshot, "status" | "materialRef"> & Equal<keyof RadioDirectionSnapshot, "motif" | "activeVariations"> & Equal<RadioDirectionValue["kind"], "text" | "material" | "scope"> & Equal<keyof EvolvedPostureSnapshot, "lean" | "commandedRevisionStamp" | "stale"> & Equal<keyof MusicExperienceRadioTruthSnapshot, "radioDirectionRevision" | "direction" | "posture"> & Equal<keyof MusicExperienceSnapshot, "queueRevision" | "radioDirectionRevision" | "radioSessionRevision" | "radioSessionLifecycle" | "playbackRevision" | "queue" | "playback" | "radio">>;
...
export type _radioNotifyRequestSubjectShape = Expect<
    ...
    Equal<NonNullable<RadioNotifyRequest["subject"]>["handle"], MaterialMusicItemHandle> &
