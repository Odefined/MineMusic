...
export type _sourceEntityForbiddenKeys = Expect<Equal<ForbiddenKeys<SourceEntity, "materialRef" | "canonicalRef" | "ownerScope" | "score" | "basis" | "provenance" | "displayLinks" | "raw" | "providerFacts" | "metadata" | "notes">, never>>;
export type _materialEntityShape = Expect<Equal<MaterialEntityKind, "recording" | "album" | "artist" | "work" | "release"> & Equal<MaterialLifecycleStatus, "active" | "merged" | "archived"> & Equal<MaterialIdentityStatus, "canonical_confirmed" | "source_backed" | "unresolved_identity"> & Equal<MaterialAvailability, "playable" | "restricted" | "unavailable" | "unknown"> & Equal<keyof MaterialEntity, "materialRef" | "kind" | "lifecycleStatus" | "identityStatus" | "canonicalRef" | "primarySourceRef" | "sourceRefs" | "versionInfo" | "createdAt" | "updatedAt">>;
...
export type _musicMaterialShape = Expect<Equal<MusicMaterial, MusicRecording | MusicAlbum | MusicArtist> & Equal<keyof MusicRecording, "kind" | "materialRef" | "primarySourceRef" | "title" | "artistLabels" | "albumLabel" | "trackPosition" | "durationMs" | "playableLinks" | "availability" | "versionInfo"> & Equal<keyof MusicAlbum, "kind" | "materialRef" | "primarySourceRef" | "title" | "artistLabels" | "releaseDate" | "playableLinks" | "availability" | "versionInfo"> & Equal<keyof MusicArtist, "kind" | "materialRef" | "primarySourceRef" | "name" | "aliases" | "playableLinks" | "availability"> & Equal<MusicRecording["kind"], "recording"> & Equal<MusicAlbum["kind"], "album"> & Equal<MusicArtist["kind"], "artist"> & Equal<ForbiddenKeys<MusicMaterial, "label" | "displayLinks" | "sourceRefs" | "canonicalRef">, never>>;
...
export type _toolInvocationPolicyShape = Expect<Equal<keyof ToolInvocationPolicy, "defaultDecision" | "dataEgress" | "readOnlyHint" | "destructiveHint" | "admissionDrivenByPresentation" | "intakeDrivenByUserRequest" | "ownerRelationDrivenByUserRequest" | "maxCallsPerTurn">>;
export type _libraryRelationPublicShapes = Expect<Equal<keyof LibraryRelationItemInput, "item"> & Equal<LibraryRelationItemInput["item"]["kind"], "library"> & Equal<keyof LibraryRelationStateOutput, "relations"> & Equal<keyof LibraryRelationStateOutput["relations"], "saved" | "favorite" | "blocked">>;
export type _stageToolContextShape = Expect<Equal<keyof StageToolContext, "ownerScope" | "sessionId" | "requestId" | "clock" | "abortSignal" | "handleMinting" | "lookupCursors" | "providerAvailability" | "executionGate" | "audit">>;
...
export type _musicExperiencePresentShapes = Expect<Equal<keyof MusicExperiencePresentInput, "item"> & Equal<keyof MusicExperiencePresentOutput, "item" | "card"> & Equal<MusicExperiencePresentOutput["item"]["kind"], "library">>;
