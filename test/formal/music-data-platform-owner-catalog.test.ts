...
export type _ownerCatalogProjectionCommandsShape = Expect<Equal<keyof OwnerCatalogProjectionCommands, "rebuildSourceLibraryEntriesForLibrary" | "rebuildSourceLibraryEntriesForMaterial" | "rebuildOwnerRelationEntries" | "rebuildCollectionEntries" | "rebuildScanRootEntriesForRoot" | "rebuildScanRootEntriesForMaterial" | "resolveCollectionRefsForMaterial">>;
...
assert.equal(await columnDataType(groupedDatabase, "owner_material_entries", "provenance_json"), "jsonb");
