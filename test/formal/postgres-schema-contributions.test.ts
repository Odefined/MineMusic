...
} from "../../src/music_data_platform/download_schema.js";
import {
  musicDataPlatformIdentitySchema,
} from "../../src/music_data_platform/identity_schema.js";
import {
  musicDataPlatformMaterialTextProjectionSchema,
} from "../../src/music_data_platform/material_text_projection_schema.js";
import {
  musicDataPlatformOwnerCatalogEntriesSchema,
  musicDataPlatformOwnerCatalogViewSchema,
} from "../../src/music_data_platform/owner_catalog_schema.js";
import {
  musicDataPlatformOwnerRelationSchema,
} from "../../src/music_data_platform/owner_material_relation_schema.js";
import {
  musicDataPlatformProjectionMaintenanceSchema,
} from "../../src/music_data_platform/projection_maintenance_schema.js";
import {
  musicDataPlatformRetrievalResultSetSchema,
} from "../../src/music_data_platform/retrieval_result_set_schema.js";
import {
  musicDataPlatformSourceLibrarySchema,
} from "../../src/music_data_platform/source_library_schema.js";
import {
  PostgresMusicDatabase,
  type PostgresMusicDatabaseSchemaContribution,
} from "../../src/storage/index.js";
import {
  stageInterfaceHandleRegistrySchema,
} from "../../src/stage_interface/handle_registry_schema.js";
import {
  stageInterfaceLookupCursorRegistrySchema,
} from "../../src/stage_interface/lookup_cursor_registry_schema.js";
import {
...
const sourceRecords = await context.get<{ table_name: string }>(`
  SELECT table_name
...
const materialTextFts = await context.get<{ indexname: string }>(`
  SELECT indexname
  FROM pg_indexes
...
const ownerCatalogView = await context.get<{ table_name: string }>(`
  SELECT table_name
