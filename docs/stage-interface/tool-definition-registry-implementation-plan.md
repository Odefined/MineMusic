...
Recommended order after the Library tracer bullet:
...
4. Canonical Review Tool Group, because review output presentation is strict.
5. Memory Tool Group, because it is small and can finish the migration.
