...
| --- | --- | --- |
| Current Canonical Store | `src/material/store/canonical/index.ts` | `createCanonicalStore` |
| Canonical normalization | `src/material/store/canonical/normalization.ts` | `normalizeCanonicalLabel`, `sameRef` |
| Canonical storage mechanics | `src/material/store/canonical/storage.ts` | `createCanonicalStorage` |
...
| Material Resolve integration | `src/material/resolve/index.ts` | `createMaterialResolveService` |
