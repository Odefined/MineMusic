...
| `phase-22-built-in-agent-frontend-implementation-plan.md` | Planned Phase 22 execution plan for the built-in local Pi-powered agent frontend: Server Host web adapter, dynamic Stage Interface to Pi tool adaptation, single in-memory session, browser workbench, guard plan, and runtime/browser verification. |
