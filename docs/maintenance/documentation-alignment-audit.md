...
| `docs/material/minemusic-musicmaterial-design.md` | Material Flow | Historical/current design content | pending-review | `docs/material/design.md` candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 2. |
| `docs/material/minemusic-musicmaterial-post-merge-review.md` | Material Flow | Historical review notes | pending-review | Archive candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 2. |
| `docs/material/minemusic_b2_narrow_material_query_design.md` | Material Flow | Boundary design slice | pending-review | `docs/material/design.md` / `docs/material/ports.md` candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 2. |
| `docs/material/minemusic_b2_narrow_material_query_pr_plan.md` | Material Flow | Historical PR plan | pending-review | Archive candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 2. |
| `docs/material/minemusic_b3_b4_projection_materialization_pr_plan.md` | Material Flow | Historical PR plan | pending-review | `docs/material/projection-materialization.md` candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 2. |
| `docs/material/minemusic_extract_material_selector_composition_pr_plan.md` | Material Flow | Historical PR plan | pending-review | Archive candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 2. |
| `docs/material/minemusic_musicmaterial_pr_plan.md` | Material Flow | Historical PR plan | pending-review | Archive candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 2. |
| `docs/material/minemusic_narrow_material_policy_selection_ports_pr_plan.md` | Material Flow | Historical PR plan | pending-review | `docs/material/ports.md` candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 2. |
| `docs/material/minemusic_stage_interface_output_ownership_design.md` | Material Flow | Boundary design slice | pending-review | `docs/material/design.md` / Stage Interface docs candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 2. |
| `docs/material/minemusic_stage_interface_output_ownership_pr_plan.md` | Material Flow | Historical PR plan | pending-review | Archive candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 2. |
| `docs/material/progress.md` | Material Flow | Current area progress | pending-review | `docs/material/progress.md` | N/A | Phase 0: inventory only | Pending | Process in Phase 2. |
...
| `docs/recommendation/minemusic_recommendation_posture_design_final.md` | Recommendation | Boundary design slice | pending-review | Material/Stage Interface docs candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 2 or Phase 6. |
| `docs/recommendation/minemusic_recommendation_posture_pr_plan_final.md` | Recommendation | Historical PR plan | pending-review | Archive candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 2 or Phase 6. |
...
| `docs/stage-interface/design.md` | Stage Interface | Current area design | pending-review | `docs/stage-interface/design.md` | N/A | Phase 0: inventory only | Pending | Process in Phase 1. |
| `docs/stage-interface/minemusic_stage_interface_tool_contract_design.md` | Stage Interface | Boundary design slice | pending-review | `docs/stage-interface/tool-contracts.md` candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 1. |
| `docs/stage-interface/minemusic_stage_interface_tool_contract_execution_plan.md` | Stage Interface | Historical execution plan | pending-review | Archive candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 1. |
| `docs/stage-interface/progress.md` | Stage Interface | Current area progress | pending-review | `docs/stage-interface/progress.md` | N/A | Phase 0: inventory only | Pending | Process in Phase 1. |
| `docs/stage-interface/stage_interface_agent_facing_language_normalization_plan.md` | Stage Interface | Historical implementation plan | pending-review | Archive candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 1. |
| `docs/stage-interface/stage_interface_language_normalization_consensus.md` | Stage Interface | Decision/consensus notes | pending-review | Stage Interface current docs or archive | Yes | Phase 0: inventory only | Pending | Process in Phase 1. |
| `docs/stage-interface/stage_interface_language_normalization_followup_plan.md` | Stage Interface | Historical implementation plan | pending-review | Archive candidate | Yes | Phase 0: inventory only | Pending | Process in Phase 1. |
| `docs/stage-interface/todo.md` | Stage Interface | Module-local TODO | pending-review | `docs/stage-interface/progress.md` or archive | Yes | Phase 0: inventory only | Pending | Process in Phase 1. |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Phase 0 Foundation | done | `docs/archive/README.md`, `INDEX.md`, `PROGRESS.md` | Yes | None found in foundation setup | Root archive entrypoint only | `rg --files -g '*.md'`; pending `git diff --check`; pending `git diff --name-only`; pending git status | `npm run check:docs` / `scripts/check-docs.mjs` is specified but not implemented; this docs-only sweep records manual equivalent checks instead. |
| Stage Interface | pending-review | Pending Phase 1 | Initial rows only | Pending | Pending | Pending | Phase 1. |
| Material Flow | pending-review | Pending Phase 2 | Initial rows only | Pending | Pending | Pending | Phase 2. |
